import { StateV2_0_0, WorkflowStatus, validateState } from '../../../state/schema-v2.0.0';

// Valid state example
const validState: StateV2_0_0 = {
...
describe('State Schema v2.0.0', () => {
  describe('validateState', () => {
    ...
    test('should reject state with invalid status', () => {
      const invalidState = {...validState, status: 'invalid-status' as WorkflowStatus};
      expect(validateState(invalidState)).toBe(false);
    });
  ...
  describe('StateV2_0_0 Interface', () => {
    test('should accept valid state object type', () => {
      const valid: StateV2_0_0 = validState;
