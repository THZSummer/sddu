...
3. 规范文件将自动创建在 `.sddu/specs-tree-root/specs-tree-[feature]/` 标准目录
...
### 3. 增强的状态管理
- ✅ 全局状态追踪 (`.sddu/specs-tree-root/state.json`)  
- ✅ 单 feature 状态隔离 (`.sddu/specs-tree-root/specs-tree-[feature]/state.json`)
...
- `@sddu-discovery` - 深度需求挖掘专家 (SDDU 新增)
...
- 🔄 新版格式 `.sddu/specs-tree-root/specs-tree-[feature]/` (推荐)
- 🔄 两种格式可并存在同一项目
...
详见: [`.sddu/docs/migration-guide.md`](./docs/migration-guide.md) 

## 文档资源

- 📝 **迁移指南**: `.sddu/docs/migration-guide.md` - SDD 到 SDDU 迁移详细步骤
- ❓ **FAQ**: `.sddu/docs/faq.md` - 常见问题解答
- 🔧 **容器化 FAQ**: `.sddu/docs/containerization-faq.md` - 目录结构 FAQ
- 📂 **文档目录导航**: `.sddu/docs/README.md` - docs 目录完整导航
- 🗺️ **路线图**: `.sddu/ROADMAP.md` - 版本规划和未来功能
- 📊 **TREE**: `.sddu/TREE.md` - 详细目录结构规范
