...
本文档整合了 SDDU 完整版本历史 (v1.1-v1.4) 与未来多 Feature 树形结构优化规划 (v2.4-v2.9)。
...
| **v2.6.0** | Phase 2: 能力增强 | 2026-04-30 | 📋 规划中 | P1 🥈 | Skills + TUI + MCP | [↓ 展开 ↓](#v260------phase-2-能力增强) |
| **v2.7.0** | 状态管理优化 | 2026-05-02 | 📋 规划中 | P0 🥈 | auto-aggregator, schema-v2.1.0 | [↓ 展开 ↓](#v270------状态管理优化) |
| **v2.8.0** | 文件命名标准化 | 2026-05-09 | 📋 规划中 | P2 | migrate-naming.sh | [↓ 展开 ↓](#v280------文件命名标准化) |
| **v2.9.0** | Build 阶段完善 | 2026-05-16 | 📋 规划中 | P2 | 4-build.md.hbs | [↓ 展开 ↓](#v290------build-阶段完善) |
