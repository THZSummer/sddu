...
本文档整合了 SDDU 完整版本历史 (v1.1-v1.4) 与未来多 specs-tree 树形结构优化规划 (v2.4-v2.8)。
...
| **v2.4.0** | specs-tree 树形结构优化 | 2026-04-25 | 📋 规划中 | P0 🥇 | 顶层规划 + 树形结构 + 子 Feature 管理 | [↓ 展开 ↓](#v240------specs-tree-树形结构优化) |
