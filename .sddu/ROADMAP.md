...
**愿景**: SDDU 当前多 Feature 支持存在架构缺陷：specs-tree-root 缺少顶层规划文档、Feature 采用水平拆分而非树形结构、状态管理分散、文件命名不统一、Build 阶段文档缺失。本 Roadmap 旨在通过 5 个阶段的系统性优化，建立完整的树形 Feature 管理体系。

**核心问题清单**:
| 问题 ID | 问题描述 | 严重性 |
|---------|----------|--------|
| P-001 | specs-tree-root 缺少 spec.md/plan.md/tasks.md | 🔴 P0 |
| P-002 | Feature 水平拆分，非树形结构 | 🔴 P0 |
| P-003 | 状态管理分散，无父子汇聚 | 🔴 P0 |
| P-004 | 文件命名不统一 | 🟡 P1 |
| P-005 | 缺少 Build 阶段文档 | 🟡 P1 |

**版本总览表**:
| 版本 | 主题 | 发布时间 | 状态 | 优先级 | 核心功能 | 关键交付物 |
|------|------|----------|------|--------|----------|------------|
| v2.4.0 | 顶层规划规范化 | 2026-04-18 | 📋 规划中 | P0 🥇 | specs-tree-root 完整 SDDU 流程 | 1-spec.md, 2-plan.md, 3-tasks.md |
| v2.5.0 | 树形 Feature 结构 | 2026-04-25 | 📋 规划中 | P1 🥉 | sub-features 嵌套、依赖管理 | subfeature-manager, tree-structure-guide |
| v2.6.0 | 状态管理优化 | 2026-05-02 | 📋 规划中 | P0 🥈 | 状态汇聚、版本管理 | auto-aggregator, schema-v2.1.0 |
| v2.7.0 | 文件命名标准化 | 2026-05-09 | 📋 规划中 | P2 | 统一命名、迁移脚本 | migrate-naming.sh, naming-convention |
| v2.8.0 | Build 阶段完善 | 2026-05-16 | 📋 规划中 | P2 | Build 文档模板、Agent 更新 | 4-build.md.hbs, build-workflow |
