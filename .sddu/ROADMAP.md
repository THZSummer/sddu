...
> **文档版本**: 8.1.0
> **更新日期**: 2026-06-21 (增量更新 — 新增 FR-ARCH-001 架构解耦 + FR-BUG-001 Bug 流程框架化)
> **状态**: 规划中 (v3.0.0 待启动)
> **生成方式**: `@sddu-roadmap` 全量扫描 16 Feature 的 state.json + spec.md + tasks.md + spec.json + validation-report.md + docs/ + TREE.md + 用户新需求评估
> **当前项目版本**: v1.4.1
> **全局状态**: 15 validated, 0 tracked, 1 terminated | 待处理项目: 41 (↑1: FR-BUG-001 新提案) | 新提案: 2 (FR-ARCH-001, FR-BUG-001)
...
| **进行中 (tracked)** | **0** ⚠️ |
| **搁置 (suspended)** | 0 |
| **已知待解决问题** | **42 (A-F + H-I 核心 + ARCH-001, BUG-001 新提案 + 32 审计发现)** |
...
| **v3.1.0** | 架构解耦与增强 | TBD | 💡 提议中 | FR-ARCH-001 解耦 + FR-BUG-001 Bug 流程 + Skills/TUI/MCP |
...
| 5 | **FR-ARCH-001**: SDDU 架构解耦 🆕 | v3.1.0 | 9 | 9 | 65% | 8 | **7.1** | P0 |

> **注**: Issue G (模板质量) 已通过 FR-TPL-001 (v3.0.1) 解决完成，不参与排名。FR-ARCH-001 与 FR-BUG-001 为新提案。完整 10 项 RICE 排名见「跨版本 RICE 总排名」节。
...
| **FR-BUG-001**: Bug 追踪与修复流程框架化 🆕 | — | 🥇 P0 | 3-5d | Bug 模板 + 轻/重修复规则 + 跨项目跟随 |
...
| 排名 | Feature | Reach | Impact | Conf. | Effort | **RICE** | 优先级 |
|:----:|---------|:-----:|:------:|:-----:|:------:|:--------:|:------:|
| 🥇 | **FR-BUG-001**: Bug 流程框架化 🆕 | 8 | 7 | 75% | 4 | **10.5** | P0 |
...
```
FR-BUG-001 (Bug 流程) ──无硬依赖──→ 可独立于 FR-ARCH-001 先行交付
...
**建议**: FR-BUG-001 无硬依赖，可在 v3.0.0 或 v3.1.0 期间随时启动。建议在 FR-ARCH-001 discovery 开始后、实施前（利用解耦评估等待期）完成此轻量改进。
...
### 跨版本 RICE 总排名 (全部 10 项: A-F + H-I + ARCH-001 + BUG-001)

> **注**: Issue G (模板质量) 已通过 FR-TPL-001 (v3.0.1) 解决完成，不再参与排名。FR-ARCH-001 与 FR-BUG-001 为新提案。
...
| 4 | **FR-QUALITY-002**: Validate E2E | v3.0.0 | 8 | 9 | 70% | 6 | **8.4** | P0 |
| 5 | **FR-ARCH-001**: SDDU 架构解耦 🆕 | v3.1.0 | 9 | 9 | 65% | 8 | **7.1** | P0 |
| 6 | **FR-QUALITY-003**: Review/Validate 设计 | v3.0.0 | 5 | 7 | 60% | 4 | **5.3** | P1 |
| 7 | **FR-QUALITY-005**: auto-updater 修复 | v3.0.0 | 3 | 4 | 80% | 2 | **4.8** | P2 |
| 8 | **FR-KB-002**: 项目知识沉淀 | v3.2.0 | 8 | 8 | 50% | 8 | **4.0** | P1 |
| 9 | **FR-QUALITY-004**: 框架自验证 | v3.0.0 | 4 | 7 | 60% | 6 | **2.8** | P1 |
| 10 | **FR-QUALITY-006**: coordinator 兼容 | v3.0.0 | 2 | 3 | 80% | 2 | **2.4** | P2 |
...
| ✨ 增强特性 | 12 | H-I + BUG-001 🆕 + FR-014~016 + Skills/TUI/MCP + 文档模板化 + 命名标准化 + FeatureStateEnum 清理 |
...
**总计: 42 个待处理项目** (↓1: Issue G 已于 v3.0.1 解决；↑2: FR-ARCH-001 + FR-BUG-001 新提案)
...
| 5 | **ARCH-001** 🆕 | SDDU 架构解耦 | ✨ | v3.1.0 | L | 7.1 | **P0** |
| 6 | **F** | Review/Validate 设计规划 | 🐛 | v3.0.0 | M | 5.3 | **P1** |
| 7 | **B** | auto-updater 修复 | 🐛 | v3.0.0 | S | 4.8 | **P2** |
| 8 | **H** | 项目知识沉淀 | ✨ | v3.2.0 | L | 4.0 | **P1** |
| 9 | **E** | 框架自验证 | 🐛 | v3.0.0 | L | 2.8 | **P1** |
| 10 | **D** | coordinator 兼容 | 🐛 | v3.0.0 | XS | 2.4 | **P3** |
...
> **生成信息**: 本文档由 `@sddu-roadmap` Agent 于 2026-06-21 增量更新，基于 2026-06-13 深度扫描版本更新，反映 FR-TPL-001 (v3.0.1) 完成、FR-ARCH-001 (SDDU 架构解耦) 及 FR-BUG-001 (Bug 追踪与修复流程框架化) 新提案评估。扫描范围覆盖 `.sddu/specs-tree-root/` 下 16 个 Feature 目录的全部 state.json / spec.md / tasks.md / spec.json / validation-report.md 以及 `.sddu/docs/` / `.sddu/TREE.md` / 架构 ADR 目录。
