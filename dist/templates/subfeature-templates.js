 ...
 */
export function generateMainSpec(template) {
 ...
 * 生成子 Feature spec 模板
 */
export function generateSubFeatureSpec(template) {
 ...
 */
export function generateFeatureReadmeTemplate(template) {
 ...
 */
export function generateSubFeatureReadmeTemplate(template) {
